<?php
	...
	{ //als de username session leeg is (en er dus niet is ingelogd)
		echo "U bent niet ingelogd";
		echo "<br>";
		echo "<a href='Login.php'>Inloggen</a>";
	} //dan volgt er een gepast bericht met een link waar de gebruiker kan inloggen
	else 
	{ //en als er wel wordt ingelogd, volgt de rest van de pagina
?>
<html>
<head>
...
<?php
		...
		while ($profiel = mysqli_fetch_assoc($result)) { //zolang er nog data is in de $result query (die hier opnieuw wordt opgeslagen als $profiel)
			...
			if ($profiel['Phone'] != "")
			{
				echo "<tr>"; 
				echo "<td>Telefoon: </td>";
				echo "<td>0".$profiel['Phone']."</td>";
				echo "</tr>";
			} // hier wordt gekeken of telefoon wel ingevuld is
			echo "<tr>"; 
			echo "<td>Adres: </td>";
	...
	} // en hier onder wordt de else bij de login check afgesloten
